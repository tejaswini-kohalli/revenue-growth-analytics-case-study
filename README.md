...
- Avg purchase frequency = 8.55  
- LTV = 43.65  
- LTV:CAC = 14.55  

📌 Insight:
Very strong monetization efficiency → business can safely scale acquisition.
...
- Major drop observed between **view → cart stage**
- Conversion rate is low (4.3%), indicating UX or pricing friction
- Revenue is driven by a small % of repeat customers
...
- Increase paid acquisition spend (high LTV:CAC supports scaling)
...
- Analyze large-scale behavioral data
- Build funnel & retention models
...
This project focuses on real-world growth analytics:
- From raw event data → business decisions
- From SQL queries → strategic recommendations
- From analysis → revenue optimization strategy
